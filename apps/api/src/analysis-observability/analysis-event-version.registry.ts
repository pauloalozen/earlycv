...
export const BUSINESS_FUNNEL_EVENT_VERSION_MAP = {
  ...
  // Meu Monitor
  monitor_view: 1,
  monitor_profile_viewed: 1,
  monitor_profile_updated: 1,
  monitor_recommendation_viewed: 1,
  monitor_recommendation_clicked: 1,
  monitor_recommendation_saved: 1,
  monitor_recommendation_dismissed: 1,
  monitor_recommendation_feedback: 1,
  monitor_application_started: 1,
  monitor_alert_enabled_changed: 1,
  // Meu Monitor — digest por e-mail (Fase 3)
  monitor_digest_sent: 1,
  monitor_digest_delivered: 1,
  monitor_digest_opened: 1,
  monitor_digest_clicked: 1,
