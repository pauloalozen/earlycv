...
> = {
  ...
  // Liga/desliga o e-mail do Monitor (interruptor emailEnabled, em
  // qualquer direção) — backend-owned porque a mutação real acontece no
  // endpoint (ver MonitorAlertPreferenceService.update); nunca confundir
  // com monitor_digest_unsubscribed, que é exclusivo do fluxo de e-mail/token.
  monitor_alert_enabled_changed: "backend",
