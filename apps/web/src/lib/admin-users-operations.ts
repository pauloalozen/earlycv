...
const adminNavItems: BackofficeNavItem[] = [
  ...
  { href: "/admin/empresas", label: "Empresas", section: "ingestion" },
  { href: "/admin/fontes", label: "Fontes de vagas", section: "ingestion" },
  { href: "/admin/runs", label: "Runs de ingestao", section: "ingestion" },
  { href: "/admin/vagas", label: "Vagas", section: "ingestion" },
  { href: "/admin/pendencias", label: "Pendencias", section: "ingestion" },
  { href: "/admin/ingestion", label: "Ingestao", section: "ingestion" },
  { href: "/admin/perfis", label: "Perfis", phase: "fase 3", section: "negocio" },
  {
